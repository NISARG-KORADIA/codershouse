...
export const useWebRTC = (roomId, user) => {
  ...
  // We are using this for mute and unmute because we want to run useEffect on the change of button in room comp and when that happens we want to change client object now our useEffect is dependent on client which means everytime we change object it will run and we are changing object in it self so it will be stuck in a loop.
  ...
  useEffect(() => {
    ...
    const setMute = (mute, userId) => {
      ...
      // this is how you you copy the ref you can't directly assign it.
